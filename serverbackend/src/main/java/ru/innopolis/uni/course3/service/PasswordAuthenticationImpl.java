 ...
 */
@Service
public final class PasswordAuthenticationImpl implements PasswordAuthentication {
    ...
    public PasswordAuthenticationImpl() {
    }
    ...
    public static String encode(String newPassword) {
        ...
        return PasswordAuthentication.PASSWORD_ENCODER.encode(newPassword);
    }

    public static boolean isMatch(String rawPassword, String password) {
        return PasswordAuthentication.PASSWORD_ENCODER.matches(rawPassword, password);
    }
