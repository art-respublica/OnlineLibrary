...
public class TestData {
    ...
    public static final Book BOOK3 = new Book(BOOK1_ID + 2, "Шарль Перро", "Красная Шапочка", 2016, "Жила-была маленькая девочка. Была она скромная и добрая, послушная и работящая...");
    public static final Book BOOK4 = new Book(BOOK1_ID + 3, "Ганс Христиан Андерсен", "Гадкий утёнок", 2014, "Хорошо было за городом! Стояло лето. На полях уже золотилась рожь, овес зеленел, сено было смётано в стога...");
    public static final Book BOOK5 = new Book(BOOK1_ID + 4, "Ганс Христиан Андерсен", "Дикие лебеди", 2015, "Далеко-далеко, в той стране, куда улетают от нас на зиму ласточки, жил король...");
    public static final Book BOOK6 = new Book(BOOK1_ID + 5, "Ганс Христиан Андерсен", "Дюймовочка", 2016, "Жила-была женщина; очень ей хотелось иметь ребёнка...");
    public static final Book BOOK7 = new Book(BOOK1_ID + 6, "Гримм, братья Вильгем и Якоб","Белоснежка и семь гномов", 2014, "Было то в середине зимы, падали снежинки, точно пух с неба, и сидела королева у окошка..");
    public static final Book BOOK8 = new Book(BOOK1_ID + 7, "Гримм, братья Вильгем и Якоб","Горшочек каши", 2015, "Жила-была одна девочка. Пошла девочка в лес за ягодами и встретила там старушку...");
    public static final Book BOOK9 = new Book(BOOK1_ID + 8, "Гримм, братья Вильгем и Якоб","Бременские музыканты", 2016, "Много лет тому назад жил на свете мельник. И был у мельника осел...");
    ...
    public static Book getCreatedBook() {
        return new Book(null, "Сказки народов мира", "Волшебная лампа Алладина", 2016, "В одном персидском городе жил когда-то бедный портной...");
    }

    public static Book getUpdatedBook() {
        return new Book(BOOK1_ID, "Unknown author", "Untitled", 2017, "...");
    }
